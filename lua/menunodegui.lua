local orig_i = CoreMenuNodeGui.NodeGui.init
function CoreMenuNodeGui.NodeGui:init(node, layer, parameters)
	for _, v in pairs({"VMBI_menus", "VMBI_ingame", "VMBI_ghosts"}) do
		if node == MenuHelper:GetMenu(v) then
...
function CoreMenuNodeGui.NodeGui:setup_custom_funcs()
